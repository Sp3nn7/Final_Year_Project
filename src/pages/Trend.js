...
/**
 * Renders TrendSelector, CitySelector and LineChart elements. Handles toggling of items, cities and inflation.
 * @param {} active - sets active object, includes active cities, item and inflation. 
 * @returns 
 */
