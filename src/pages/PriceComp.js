            ...
            {shoppingList.length > 0 ? shoppingList.map((item, i) => (
                  <tr key={item.id}>
                    ...
                    </td>
                    {
                        item.quantity === 1 ?
                        <td style={{width:"20px"}}>
                            <button style={{color:"lightgrey", pointerEvents:"none"}} className="btn btn-Secondary btn-fixed" onClick={() => null}>-</button>
                        </td>
                        :
                        <td style={{width:"20px"}}>
                    ...
                    <td><button className="btn btn-Secondary btn-fixed btn-delete" onClick={() => deleteItemFromShoppingList(item.name)}>×</button></td>
                  </tr>
                )) :
                <tr key={0}>
                    <td></td>
